...
class Executor : public Interpreter {
  ...
  friend class DRandomPathSearcher;
...
private:
  ...
  virtual void printFileLine(ExecutionState &state, KInstruction *ki);
  ...
  virtual void initializeGlobalObject(ExecutionState &state, ObjectState *os, 
  ...
  virtual ObjectState *bindObjectInState(ExecutionState &state, const MemoryObject *mo,
  ...
  virtual void resolveExact(ExecutionState &state,
                    ref<Expr> p,
  ...
  virtual void executeAlloc(ExecutionState &state,
                    ref<Expr> size,
                    bool isLocal,
                    KInstruction *target,
...
public:
  Executor(const InterpreterOptions &opts);
  Executor(const InterpreterOptions &opts, Solver *_coreSolver, KModule *_kmodule);

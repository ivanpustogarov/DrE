...
ref<Expr> Expr::createTempRead(const Array *array, Expr::Width w,	bool periph) {
  ...
  case Expr::Int8: 
    return ReadExpr::create(ul, 
                            ConstantExpr::alloc(0,Expr::Int32), periph);
  case Expr::Int16: 
    return ConcatExpr::create(ReadExpr::create(ul, 
                                               ConstantExpr::alloc(1,Expr::Int32), periph),
                              ReadExpr::create(ul, 
                                               ConstantExpr::alloc(0,Expr::Int32), periph));
  case Expr::Int32: 
    return ConcatExpr::create4(ReadExpr::create(ul, 
                                                ConstantExpr::alloc(3,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(2,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(1,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(0,Expr::Int32), periph));
  case Expr::Int64: 
    return ConcatExpr::create8(ReadExpr::create(ul, 
                                                ConstantExpr::alloc(7,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(6,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(5,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(4,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(3,Expr::Int32), periph),
                               ReadExpr::create(ul, 
                                                ConstantExpr::alloc(2,Expr::Int32), periph),
...
ref<Expr> ReadExpr::create(const UpdateList &ul, ref<Expr> index, bool periph) {
  ...
  return ReadExpr::alloc(ul, index, periph);
}

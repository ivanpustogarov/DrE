...
public:
  ...
  virtual void setArch(Architecture * arch) = 0;
  //virtual KModule* getKMuldule(Architecture * arch) = 0;
  ...
  //                                  std::vector< ref<Expr> > *ret_conds) = 0;
  //virtual void runSupplCall(SupplCall &suppl_call);

  //virtual void startCompositSymbEx(llvm::Function *f, int argc, char **argv, char **envp) = 0;
  //virtual int path_main_routine(std::string start_function, std::string target_function); // The main function to build path
